...
class TestConsoleDocs(unittest.TestCase):
    ...
    #         self.assertIn("{self.c_name}.{output}", storage.all().keys())
    ...
    #         with patch('sys.stdout', new=StringIO()) as mock_stdout:
    #             cmd = "create {} email=x@g.c password=1".format(self.c_name)
    #             HBNBCommand().onecmd(cmd)
    ...
    #     expected = '{}: {} **'
    #     self.assertEqual(
    #         output, expected.format(error_messages["no_method"], method_name)
    #     )
